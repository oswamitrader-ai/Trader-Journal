...
59. **Correção Definitiva da Sincronização em Tempo Real de Saques e Depósitos (App Desktop vs Painel Web)**:
    ...
    - **Solução Implementada**:
      ...
      - Em [App.tsx](file:///c:/Users/swami/Downloads/Trader-Journal-main/Trader-Journal-main/src/App.tsx), a função `refetchAllData` agora substitui o estado `capitalTransactions` diretamente com o retorno atualizado do Supabase, garantindo que adições, edições, exclusões e importações de saques/depósitos no App Desktop apareçam em sub-50ms no Painel Web sem necessidade de dar F5.
